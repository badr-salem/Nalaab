...
namespace Nalaab.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "كلمة المرور يجب أن لا تقل عن 6 عناصر", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "كلمة الممرور وتأكيد كلمة المرور غير متطابقتين")]
