    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            else
            {
                ...
                productVM.AgeGroupList = _unitOfWork.AgeGroup.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                });
        ...
        {
            var allObj = _unitOfWork.Product.GetAll(includeProperties: "Category,AgeGroup");
